<template>
  <section>
    ...
    <article class="center-flexbox">
      <textarea style="resize: none" v-model="content" class="create-msg-container" id="text-area" ></textarea>
    ...
    <div class="create-message-button-container">
      <button class="create-message-button" @click="createMessage()">Publicera</button>
    </div>
  </section>
</template>
<script>
...
export default {
  ...
  methods: {
    createMessage() {
      const encryptedContent = CryptoJS.AES.encrypt(this.content, sessionStorage.getItem('userkey')).toString();
